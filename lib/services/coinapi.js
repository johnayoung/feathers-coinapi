...
const { axiosErrorHandler } = '../error-handler.js';
...
const transformResponse = axios.defaults.transformResponse.concat(function (
  data
) {
  const tmp = function (item) {
...
const COIN_API_SDK = (function () {
  ...
  COIN_API_SDK.prototype.ohlcv_latest_data_agg = function (
    asset_id_base,
    asset_id_quote,
    period_id,
    limit
    ...
    const path = `${this.url}/v1/ohlcv/${asset_id_base}/${asset_id_quote}/latest?period_id=${period_id}`;
    const params = {};
    if (limit) {
      params.limit = limit;
    }
  ...
  COIN_API_SDK.prototype.ohlcv_historic_data = function (
    ...
    const path = `${
      this.url
    }/v1/ohlcv/${symbol_id}/history?period_id=${period_id}&time_start=${time_start.toISOString()}`;
    const params = {};
    if (time_end) {
  ...
  COIN_API_SDK.prototype.ohlcv_historic_data_agg = function (
    asset_id_base,
    asset_id_quote,
    period_id,
    time_start,
    ...
    const path = `${
      this.url
    }/v1/ohlcv/${asset_id_base}/${asset_id_quote}/history?period_id=${period_id}&time_start=${time_start.toISOString()}`;
    const params = {};
    if (time_end) {
      params.time_end = time_end.toISOString();
    }
  ...
  COIN_API_SDK.prototype.trades_historical_data = function (
    ...
    const path = `${
      this.url
    }/v1/trades/${symbol_id}/history?time_start=${time_start.toISOString()}`;
    const params = {};
    if (time_end) {
      params.time_end = time_end.toISOString();
    }
  ...
  COIN_API_SDK.prototype.quotes_historical_data = function (
    ...
    const path = `${
      this.url
    }/v1/quotes/${symbol_id}/history?time_start=${time_start.toISOString()}`;
    const params = {};
    if (time_end) {
      params.time_end = time_end.toISOString();
    }
  ...
  COIN_API_SDK.prototype.orderbooks_latest_data = function (
    symbol_id,
    limit_levels,
    limit
  ) {
  ...
  COIN_API_SDK.prototype.orderbooks_historical_data = function (
    ...
    const path = `${
      this.url
    }/v1/orderbooks/${symbol_id}/history?time_start=${time_start.toISOString()}`;
    const params = {};
    if (time_end) {
      params.time_end = time_end.toISOString();
    }
  ...
  COIN_API_SDK.prototype.orderbooks3_current_data_all = function () {
    const path = `${this.url}/v1/orderbooks3/current`;
    return axios
      .get(path, {
        headers: this.headers,
        transformResponse,
  ...
  COIN_API_SDK.prototype.orderbooks3_current_data_symbol = function (
    symbol_id,
    limit_levels
  ) {
    const path = `${this.url}/v1/orderbooks3/${symbol_id}/current`;
    let query = {
      headers: this.headers,
      transformResponse,
    };
    ...
    return axios.get(path, query).then(function (resp) {
      return resp.data;
    });
  };
  return COIN_API_SDK;
